...
-(id)initWithSize:(CGSize)size{
    if (self = [super initWithSize:size]) {
        ...
        for (int i=0; i<5; i++) {
            ...
            PPBasicSpriteNode *activityBarContent=[[PPBasicSpriteNode alloc] initWithColor:[UIColor brownColor] size:CGSizeMake(280.0f, 50)];
            ...
            [joinButton addTarget:self selector:@selector(joinButtonClick:) withObject:joinButton.name forControlEvent:PPButtonControlEventTouchUpInside];
