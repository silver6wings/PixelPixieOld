...
-(void)setSideElements:(PPPixie *)playerpixie andEnemy:(PPPixie *)enemyppixie;{
    ...
    [petPlayerHP setMaxValue:playerpixie.pixieHPmax andCurrentValue:playerpixie.currentHP andShowType:PP_HPTYPE andAnchorPoint:CGPointMake(0.0f, 0.5f)];
    ...
    [petPlayerMP setMaxValue:playerpixie.pixieMPmax andCurrentValue:playerpixie.currentMP andShowType:PP_MPTYPE andAnchorPoint:CGPointMake(0.0f, 0.5f)];
